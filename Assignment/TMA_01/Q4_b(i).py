# Write an application that manages the seat booking process for FR.
# The program has a main menu, where current production titles are listed 
# in alphabetical order, followed by the performance datetime in chronological order, as follows:
